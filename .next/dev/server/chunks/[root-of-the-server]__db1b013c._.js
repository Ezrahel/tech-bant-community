...
"[project]/app/api/v1/posts/[id]/share/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        const { data: post, error: fetchError } = await supabase.from('posts').select('shares').eq('id', postId).single();
        if (fetchError || !post) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Post not found', 404);
        ...
        if (updateError) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Failed to update share count', 500);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db1b013c._.js.map