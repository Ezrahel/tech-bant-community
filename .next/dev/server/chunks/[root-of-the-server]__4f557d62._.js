...
"[project]/app/api/v1/posts/categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (error) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Failed to fetch category counts', 500);
        }
        // Aggregate counts
        const counts = {};
        let totalCount = 0;
        ...
        const categories = [
            ...
            },
            {
                id: 'updates',
                name: 'Updates',
                count: counts['updates'] || 0
            },
            {
                id: 'gists',
                name: 'Gists',
                count: counts['gists'] || 0
            },
            {
                id: 'banter',
                name: 'Banter',
                count: counts['banter'] || 0
            }
        ];
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])(categories);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f557d62._.js.map